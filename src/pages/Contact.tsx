...
import { MapPin, Phone, Mail, Clock, Send, MessageSquare, Building, ShoppingBag } from "lucide-react";
...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visit Us",
    details: ["Golden Nature Plantation (Pvt) Ltd", "42 Plantation Avenue", "Colombo 07, Sri Lanka"],
  },
  {
    icon: Phone,
    title: "Call Us",
  ...
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["info@goldennature.lk", "sales@goldennature.lk"],
  },
  {
    icon: Clock,
    title: "Working Hours",
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-elegant text-xl text-ivory/85 leading-relaxed">
              Whether you have questions about our products, partnership opportunities, 
              or investment inquiries, we're here to help.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2">
              <h2 className="font-display text-3xl text-foreground mb-8">Contact Information</h2>
                  ...
                  <div key={item.title} className="flex gap-4">
                    ...
                    <div>
                      ...
                      {item.details.map((detail, i) => (
                        <p key={i} className="font-body text-muted-foreground">{detail}</p>
                      ))}
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-12 rounded-2xl overflow-hidden h-64 bg-muted">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63371.80385475647!2d79.82118295!3d6.9270786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae253d10f7a7003%3A0x320b2e4d32d3838d!2sColombo%2C%20Sri%20Lanka!5e0!3m2!1sen!2sus!4v1699999999999!5m2!1sen!2sus"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
            ...
            <div className="lg:col-span-3">
              <div className="bg-ivory rounded-2xl p-8 md:p-12 shadow-elevated">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Inquiry Type */}
                  <div>
                    <label className="font-body text-sm text-foreground mb-3 block">What can we help you with?</label>
                      ...
                      {inquiryTypes.map((type) => (
                        ...
                        >
                          <type.icon className={`w-6 h-6 mx-auto mb-2 ${
                            formData.inquiryType === type.value ? "text-emerald" : "text-muted-foreground"
                          }`} />
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="font-body text-sm text-foreground mb-2 block">Email Address *</label>
                      <Input
                        type="email"
                  ...
                  {/* Phone */}
                  <div>
                    <label className="font-body text-sm text-foreground mb-2 block">Phone Number</label>
                    <Input
                      type="tel"
      ...
      <section className="py-16 bg-emerald">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h3 className="font-display text-2xl text-ivory mb-2">Need Immediate Assistance?</h3>
              <p className="font-body text-ivory/80">Our team is available during business hours for urgent inquiries.</p>
            </div>
