...
const reasons = [
  {
    ...
    description: "Every leaf is grown without synthetic chemicals, preserving nature's pure essence for your wellbeing.",
  },
  {
    icon: Shield,
    title: "Certified Quality",
    description: "International certifications including ISO, HACCP, and organic standards ensure uncompromising quality.",
  },
  {
    icon: Gem,
    title: "Premium Selection",
    description: "Only the finest 5% of our harvest makes it to your cup, hand-selected by master tea artisans.",
  },
  {
    icon: Users,
    title: "Fair Trade",
    description: "We empower our farming communities with fair wages, education, and sustainable livelihoods.",
  },
  {
    icon: Globe2,
    title: "Global Standards",
    description: "Meeting and exceeding international quality benchmarks trusted by discerning customers worldwide.",
  },
  {
    icon: Recycle,
    title: "Sustainable Future",
    description: "From biodegradable packaging to carbon-neutral operations, we protect our planet for generations.",
  },
];
    ...
    <section className="py-24 bg-emerald relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="font-body text-sm tracking-widest uppercase text-gold">Why Golden Nature</span>
          ...
          <p className="font-elegant text-xl text-ivory/80 max-w-2xl mx-auto italic">
            "In every golden leaf lies our commitment to purity, our respect for tradition, 
            and our promise to deliver nothing but the finest nature has to offer."
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <p className="font-body text-ivory/70 leading-relaxed">{reason.description}</p>
            </div>
          ))}
        </div>
